 ...
 * Fallback chain: local /flags/ file → flagcdn → FIFA picture API.
 */
export default function Flag({ team, iso2, size = 22, className = '', alt = '' }: FlagProps) {
  ...
  if (!src) return <span className="flag" style={{ width: size, height: h }} />
  return (
    <img
