    ...
    <>
      <header className="shell-header" ref={headerRef}>
        <div className="shell-header-in">
          ...
          <a
            className="gh-link"
            href="https://github.com/julianchun/2026worldcup-dashboard"
            target="_blank"
      ...
      <footer className="shell-footer">
        ...
        <div className="shell-footer-links">
          <a href="https://github.com/julianchun/2026worldcup-dashboard" target="_blank" rel="noreferrer">
            GitHub
          </a>
          <span aria-hidden="true">·</span>
          <span>
            {byPre}
            <a href="https://github.com/julianchun" target="_blank" rel="noreferrer">
              Julian Chun
            </a>
            {byPost}
          </span>
          <span aria-hidden="true">·</span>
          <a
            href="https://github.com/julianchun/2026worldcup-dashboard/blob/main/COPYRIGHT.md"
            target="_blank"
            rel="noreferrer"
          >
            {t('footerLicense')}
