...
/** Wikipedia "W" glyph; inherits the surrounding text color so it works on any
 * theme (an <img>-loaded SVG can't pick up currentColor) */
export function WikipediaMark({ size = 16, className }: MarkProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** house glyph for the official-website link (inherits text color) */
export function HomeMark({ size = 19, className }: MarkProps) {
  return (
    <svg
      className={className}
      width={size}
      ...
      aria-hidden="true"
    >
      <path fillRule="evenodd" d="M9.5 2 17 9 15 9 15 17 4 17 4 9 2 9Z M8 12 11 12 11 17 8 17Z" />
    </svg>
  )
}
