...
const pt: Dict = {
  ...
  metaDesc:
    'Mundial 2026: calendário, grupos, quadro, seleções, estádios, meteorologia, onde ver e prognósticos introduzidos pelo utilizador, em 23 línguas. PWA open source não oficial',
  // nav
  navHome: 'Início',
  navMatches: 'Jogos',
  navGroups: 'Grupos',
