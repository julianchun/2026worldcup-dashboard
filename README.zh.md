...
- 📋 **比賽頁面**：開放資料脈絡、對戰紀錄、近期國際賽狀態、球場資訊、開球時段天氣預報（對於較遠日期則回退至典型氣候資料）、完整裁判組、繪製在 SVG 球場上並標註陣型的先發陣容，以及進球時間軸
...
- 🧭 **開放資料比賽脈絡**結合賽事資料與歷史國際賽結果：近期狀態、對戰紀錄、最近交手、排名優勢、休息天數、旅程距離、天氣可用性、公平競賽分數與現行停賽
