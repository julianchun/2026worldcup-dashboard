...
- 📋 **比賽頁面**：預測參考資訊、球場資訊、開球時段天氣預報（對於較遠日期則回退至典型氣候資料）、完整裁判組、繪製在 SVG 球場上並標註陣型的先發陣容、進球時間軸，以及你所在國家/地區的轉播頻道
...
- 🧭 **預測參考資訊**由可靠的賽事資料計算而來：近期狀態、排名優勢、休息天數、旅程距離、天氣可用性、公平競賽分數與現行停賽
...
| 本機計算 | 積分榜、賽事統計、停賽、休息/旅程參考資訊、prediction-context JSON |
