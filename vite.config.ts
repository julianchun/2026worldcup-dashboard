...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        id: './',
        name: '2026 World Cup Dashboard',
        short_name: '2026 WC',
        description:
          '2026 World Cup: schedule, groups, bracket, teams, venues, weather, where to watch, and user-entered match predictions. Unofficial open-source PWA',
        start_url: './',
        scope: './',
        display: 'standalone',
        orientation: 'any',
